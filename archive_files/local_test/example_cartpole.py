...
def compute_endeffector_position(
    ...
    tid = wp.tid()
    # end position
    # body_q[tid * num_links + ee_link_index]
    # 7-index array, last joint of the body
    # For ant it is different
    # For Ant, check joint names
    # joint_name: ankle_1, ankle_2, ankle_3, ankle_4
    # to get index, check joint name in compute_ee_position
...
class Example:
    ...
    def step(self):
        ...
        print(delta_q)
        print(self.model.joint_count)
        #print(self.model.joint_q.numpy())
        #print(delta_q.flatten())
